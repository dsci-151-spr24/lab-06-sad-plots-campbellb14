...
***I could highlight the part time faculty line to emphasize the difference from the full-time faculty lines.***
...
***I would improve it by showing the capture and aquaculture differences for each country in a clearer way. I would put it on one bar chart with easy to read axes and titles. I would also only include the fisheries that have a total above 1000000 because they have more data.***
